// Thin wrapper over the generic-password keychain item that holds our OAuth tokens.
...
enum Keychain {
    ...
    /// Reads a service-only item, which is how the Claude Code CLI stores its credentials.
